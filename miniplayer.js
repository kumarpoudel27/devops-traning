...
a=new g.QZ(this.player,this);g.H(this,a);a.xa(this.Fh.element);this.jr=new g.V({F:"div",L:"ytp-miniplayer-controls"});g.H(this,this.jr);this.jr.xa(this.Fh.element);this.P(this.jr.element,"click",this.CC);var b=new g.V({F:"div",L:"ytp-miniplayer-button-container"});g.H(this,b);b.xa(this.jr.element);a=new g.V({F:"div",L:"ytp-miniplayer-play-button-container"});g.H(this,a);a.xa(this.jr.element);var c=new g.V({F:"div",L:"ytp-miniplayer-button-container"});g.H(this,c);c.xa(this.jr.element);this.vQ=new g.UL(this.player,
this,!1);g.H(this,this.vQ);this.vQ.xa(b.element);b=new g.SL(this.player,this);g.H(this,b);b.xa(a.element);this.nextButton=new g.UL(this.player,this,!0);g.H(this,this.nextButton);this.nextButton.xa(c.element);this.Ih=new g.iN(this.player,this);g.H(this,this.Ih);this.Ih.xa(this.Fh.element);this.uc=new g.eM(this.player,this);g.H(this,this.uc);g.YI(this.player,this.uc.element,4);this.rC=new g.V({F:"div",L:"ytp-miniplayer-buttons"});g.H(this,this.rC);g.YI(this.player,this.rC.element,4);a=new g.V({F:"button",
Ba:["ytp-miniplayer-close-button","ytp-button"],T:{"aria-label":"Close"},R:[g.zG()]});g.H(this,a);a.xa(this.rC.element);this.P(a.element,"click",this.Lj);a=new g.V({F:"button",Ba:["ytp-miniplayer-replay-button","ytp-button"],T:{"aria-label":"Close"},R:[g.FG()]});g.H(this,a);a.xa(this.rC.element);this.P(a.element,"click",this.xZ);this.P(this.player,"presentingplayerstatechange",this.Wc);this.P(this.player,"appresize",this.vb);this.P(this.player,"fullscreentoggled",this.vb);this.vb()};
